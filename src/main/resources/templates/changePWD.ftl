...
<article class="cl pd-20">
	<form action="/" method="post" class="form form-horizontal" id="form-change-password">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>请输入原始密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" autocomplete="off" placeholder="原始密码" name="oldpassword" id="oldpassword">
			</div>
		</div>
		<div class="row cl">
	...
	$("#form-change-password").validate({
		...
		submitHandler:function(form){
			$.ajax({
				...
				data : JSON.stringify({"id":$("#userId").val(),"pwd":$("#newpassword").val()}),
				dataType:"json",
